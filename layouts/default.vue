<template>
  <header class="bg-white dark:bg-gray-900">
    <nav class="fixed w-full flex bg-white dark:bg-gray-900 z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div class="flex flex-wrap items-center justify-between mx-auto px-1 md:px-4 py-1">
